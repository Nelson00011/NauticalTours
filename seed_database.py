...
user_list = [
    ...
    ("Lulu", "Blu", '333-555-5555', b'$2b$12$9k0w1fq23Nb9nj.h/kXDBOc1rJhnk3qM3.Cw6nzDTvhxoGE/8Hid2', 'lulu@blu.com', '03/03/1990')
    ]

rating_list = [
    (3, "Arctic Winds", '2019-06-29', 5, "Amazing experience once in a life time for the 2019 sailing tour"),
    (2, "Arctic Winds", '2019-06-29', 4, "Super excited to see the all the Whales on the second day! Incredible glacial Views! Great crew."),
